    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      // String confirmpass=confirmpassword.getText();
        String uname=username.getText();
         String ps = confirmpassword.getText();
        ...
        if(currentpass.equals("admin")){
            ...
            try {
                ...
                String query = "update employee set Password = '"+ps+"'   where UserName = '"+uname+"'      ";
                 String query2="update login set PPassword='"+ps+"' where UserName='"+uname+"'";
            //execute query
            int n=stmt.executeUpdate(query);
            int n1=stmt.executeUpdate(query2);
            if(n!=0 ||n1!=0){
                JOptionPane.showMessageDialog(rootPane,"Update successfully");
                    user_loging click=new user_loging();
